    ...
    <section className={css.whyNowContainer}>
      ...
      <div className={css.whyNow}>
        ...
        <div className={css.bodyTextContainer}>
          ...
          <p className={css.whyNowBodyText}>
            Libertum is positioned to reshape the real estate investment
            landscape and unlock new possibilities for investors worldwide.
          </p>
        </div>
        <div className={css.keyPointsContainer}>
          <div className={css.keyPoints}>
            ...
            <p>
              Real Estate Tokenization is projected to experience tremendous
              growth, Libertum is determined to capitalize on our early start
              and unique approach.
            </p>
          </div>
          <div className={css.keyPoints}>
            ...
            <p>
              Predictions suggest an extremely positive crypto market in 2024,
              with RWA projects projected to lead this growth.
            </p>
          </div>
          <div className={css.keyPoints}>
            <h3 className={css.keyPointHeading}>Rising Cost of Living</h3>
            <p>
              The escalating global cost of living is posing insurmountable
              challenges for individuals looking to invest in real estate.
            </p>
          </div>
          <div className={css.keyPoints}>
            <h3 className={css.keyPointHeading}>High Interest Rates</h3>
            <p>
              The prevailing high interest rate increases the cost of borrowing
              money, especially within the commercial sector.
            </p>
          </div>
        </div>
      </div>
