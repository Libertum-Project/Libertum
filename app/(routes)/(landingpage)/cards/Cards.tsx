      ...
      <div className={css.cardContainer}>
        <div className={css.information}>
          ...
          <p>
            ...
            <br />
            <br />
            💰 Profit not property – Enjoy the benefits of a property without
            the overheads
            <br />
            <br />
      ...
      <div className={`${css.cardContainer} ${css.secondCard}`}>
        ...
        <div className={css.information}>
          ...
          <p>
            ...
            Libertum Marketplace to unlock your properties potential. Access
          ...
          <p>
            ...
            <br />
            <br />
            🕹️ Control Your Asset — unlike costly complicated and expensive
            alternatives, you maintain ownership of your property
            <br />
      ...
      <div className={css.cardContainer}>
        <div className={css.information}>
          ...
          <p>
            ...
            Libertum is a simple and intuitive platform that allows you to
            invest in premium properties to immediately enjoy rental income.
            Unlike alternative solutions that establish complex and costly
          ...
          <p>
            ...
            <br />
            <br />
            ⛓️ Enhanced Liquidity — trade their tokens on our P2P
