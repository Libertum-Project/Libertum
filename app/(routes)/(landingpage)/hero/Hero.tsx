...
export function Hero(): ReactElement {
  ...
  return (
    <div className="relative pt-20 overflow-hidden">
      {isMobile ? (
        <div className="absolute top-0 z-10 bg-gradient-to-b from-[#000041] to-[#0E0E1E] mix-blend-multiply "></div>
      ) : (
      ...
      <div className="py-12 lg:py-24 max-w-[75.125rem] mx-auto flex items-center justify-start gap-12 relative box-border z-20 overflow-visible">
        <section className="hidden lg:block absolute top-0 left-0 z-20">
          <HeroSplineLanding />
        </section>
        <section className="flex items-start flex-col justify-start gap-8 max-w-2xl box-border z-30">
          ...
          <section className="flex flex-col lg:flex-row items-start gap-8 w-full">
            <Link
              href="/subscribe"
              className="flex px-4 py-3 justify-between items-center border border-libertumGreen rounded-[.5rem] bg-[#ffffff03] backdrop-filter backdrop-blur-sm text-white font-space_grotesk font-bold cursor-pointer whitespace-nowrap text-xs hover:bg-[#00b3b54d] h-full w-full"
            >
            ...
            >
              <div className="flex justify-center items-center gap-4">
                <Image src="assets/earn.svg" alt="earn" width={36} height={36} />
                <p>Stake LBM</p>
              </div>
            ...
            >
              <div className="flex justify-center items-center gap-4">
                <Image src="/assets/get-icon-light.png" alt="N" width="13" height="13" />
                <p>Get LBM</p>
              </div>
