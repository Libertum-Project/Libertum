  ...
  return (
    <div className={css.container}>
      ...
      {isMobile ? (
        ...
        <div className={css.tabAccordionMobile}>
          <div className={css.options}>
            {options.map((option) => (
              <div key={option.id} className={css.tabPanelMobile}>
                <div
                  className={`${css.frameTitleMobile} ${expandedOptions.includes(option.id) ? css.active : css.inactive}`}
                ...
                {expandedOptions.includes(option.id) && (
                  <div className={css.informationMobile}>
                    <div>
