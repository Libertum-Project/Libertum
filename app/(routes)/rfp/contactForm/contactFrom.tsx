...
export function ContactForm(): ReactElement {
  ...
  return (
    <div className={css.formContainer}>
      <form ref={form} onSubmit={simulateSendEmail} className={css.inputsBox}>
        ...
        <select className={css.input} id="IDIQ" name="IDIQ" required autoComplete="off">
        ...
        <input type="text" placeholder="Leave a message" className={css.inputMessage} id="message" name="message" />
