  ...
  const cardsData = [
    {
      ...
      description:
        "Since there is no ownership transfer, this investment remains delta-neutral, eliminating capital depreciation risk.",
      imageSrc: "/assetsLanding/noTransfer.svg",
    },
    {
      title: "No Hidden Fees",
      description:
        "Our project prioritizes transparency, allowing investors to consider all factors before making informed decisions.",
      imageSrc: "/assetsLanding/eye.svg",
    },
    {
      title: "Secure Platform",
      description:
        "Properties are used as collateral for the rental income tokens listed, ensuring the security of your initial investment.",
      imageSrc: "/assetsLanding/secure.svg",
    },
    {
      title: "High Rental Yield",
      description:
        "Invest in prime real estate within London's bustling commercial district and enjoy substantial monthly income.",
      ...
      <div className="mt-32 bg-white lg:bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] bg-opacity-20  rounded-3xl border-gray-200  p-16 shadow-3xl lg:mx-auto lg:max-w-screen-2xl">
        <div className="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
          <div className="text-gray-100">
            <h2 className="my-8 text-2xl font-bold text-slate-800 md:text-4xl">
              Why Libertum?
            </h2>
            <p className="text-gray-800 text-xl">
              {" "}
              Libertum distinguishes itself from other real estate projects in
              the crypto space through several key characteristics:
            </p>
          </div>
