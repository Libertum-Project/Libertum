              ...
              <div>
                ...
                <div className="mt-6">
                  <h2 className="text-3xl font-bold tracking-tight text-gray-700">
                    The next stage in the evolution of real estate investment is
                    here.
                  </h2>
                  <p className="mt-4 text-lg text-gray-600">
                    Libertum eliminates the need for intermediaries, making real
                    estate investment cost-effective and efficient, benefiting
                    both investors and property professionals.
                  </p>
                  <p className="mt-4 text-lg text-gray-600">
                    Libertum will unite small and large investors with property
                    owners on our global peer to peer platform, granting local
                    property investment opportunities global exposure and
                    opening doors for retail investors worldwide.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="mt-6">
                  ...
                  <p className="mt-4 text-lg text-gray-600">
                    ...
                    dedicated to an ongoing buyback and burn strategy, aimed at
                    increasing the value of our tokens and benefiting early
                    stakeholders.
                  </p>
