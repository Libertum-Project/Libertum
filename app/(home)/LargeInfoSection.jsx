...
export default function LargeInfoSection() {
  return (
    <>
      <div className="relative overflow-hidden bg-opacity-20 rounded-xl pt-16 pb-32 space-y-24 mt-6">
        {/* Primera Sección */}
          ...
          <div className="relative">
            <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8">
              ...
              <div className="mt-12 sm:mt-16 lg:mt-0">
                <div className="-mr-48 pl-6 md:-mr-16 lg:relative lg:m-0 lg:h-full lg:px-0 object-fill">
                  <Image
                    loading="lazy"
                    width={547}
                    height={386}
                    className="w-full rounded-xl shadow-2xl ring-1 ring-black ring-opacity-5 lg:absolute lg:left-0 lg:h-full  "
        ...
        <Slide direction={"right"} triggerOnce={true}>
          <div className="relative">
            <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8">
              ...
              <div className="mt-12 sm:mt-16 lg:mt-0">
                <div className="-ml-48 pr-6 md:-ml-16 lg:relative lg:m-0 lg:h-full lg:px-0 object-fill">
                  <Image
                    alt="Interfaz de usuario de correo electrónico"
                    loading="lazy"
                    width={547}
                    height={386}
                    className="w-full rounded-xl shadow-xl ring-1 ring-black ring-opacity-5 lg:absolute lg:right-0 lg:h-full "
                    style={{ color: "transparent" }}
              ...
              <div className="mt-12 sm:mt-16 lg:mt-0">
                <div className="-mr-48 pl-6 md:-mr-16 lg:relative lg:m-0 lg:h-full lg:px-0 object-fill">
                  <Image
                    ...
                    width={646}
                    height={485}
                    className="w-full rounded-xl shadow-2xl ring-1 ring-black ring-opacity-5 lg:absolute lg:left-0 lg:h-full lg:w-auto "
                    style={{ color: "transparent" }}
