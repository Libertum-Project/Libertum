...
import { ChatBubbleLeftIcon, DocumentTextIcon, HomeIcon, DevicePhoneMobileIcon, CurrencyDollarIcon } from '@heroicons/react/20/solid';
          ...
          <div className="p-4">
            ...
            {menuItems.map((item, index) => (
              <li key={index} className="mb-6">
                ...
                >
                  <item.icon className="inline-block w-6 h-6 mr-2 " /> {item.name}
                </Link>
              </li>
            ))}
            </ul>
