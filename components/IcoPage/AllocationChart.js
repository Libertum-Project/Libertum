...
//           {chartData.labels.map((label, index) => (
//             <div key={index} className="chart-segment" style={{ backgroundColor: chartData.datasets[0].backgroundColor[index] }}>
...
//       <section>
//         <h2>ALLOCATION OF THE $LBM TOKENS</h2>
//         <p>We believe in a conservative approach to ensure price stability...</p>
//         <div className="legend-container">
//           {chartData.labels.map((label, index) => (
//             <div key={index} className="legend-item">
//               <span className="legend-color" style={{ backgroundColor: chartData.datasets[0].backgroundColor[index] }}></span>
