    ...
    const aboutLibertum = [
        {
            ...
            answer: (
                <ul>
                    <li>$LBM is an ERC-20 token on the Polygon Smart Chain with a maximum supply of only 200,000,000 (200 million). </li>
                    <br />
                    <li>
                        The $LBM Token is the native token on the blockchain that is the backbone of the Libertum fractionalized rental income ecosystem.</li>
                    <br />
                    <li>
        ...
        },
        {
            ...
            answer: (
                <ul>
                    <li>The $LBM token will be fueling the vibrant Libertum rental income ecosystem.
