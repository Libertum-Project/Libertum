...
<div class="flex flex-col items-center mt-8 justify-center light">
  <div class="w-full  bg-white rounded-[2rem] shadow-md p-6">
    ...
    <form className="flex flex-col">
      ...
      <button className="bg-primary-200 text-white font-bold py-2 px-4 rounded-md mt-4 hover:bg-indigo-600 hover:to-blue-600 transition ease-in-out duration-150" type="submit">
        Subscribe
      </button>
    </form>
